 ...
 */
(rootLayout: View, contentElements: ArrayList<PaperOnboardingPage>?, appContext: Context) : PaperOnboardingEngineDefaults {
  ...
  protected fun toggleContent(prev: Boolean) {
    ...
    val pagerMoveAnimation = ObjectAnimator.ofFloat(mPagerIconsContainer, "x", mPagerIconsContainer.x, newPagerPosX)
    pagerMoveAnimation.setDuration(PaperOnboardingEngineDefaults.Companion.ANIM_PAGER_BAR_MOVE_TIME.toLong())
  ...
  protected fun createBGAnimatorSet(color: Int): AnimatorSet {
    ...
    val fadeIn = ObjectAnimator.ofFloat(bgColorView, "alpha", 0, 1)
    ...
    bgAnimSet.duration = PaperOnboardingEngineDefaults.Companion.ANIM_BACKGROUND_TIME.toLong()
  ...
  private fun createContentTextShowAnimation(currentContentText: View, newContentText: View): AnimatorSet {
    val positionDeltaPx = dpToPixels(PaperOnboardingEngineDefaults.Companion.CONTENT_TEXT_POS_DELTA_Y_DP)
    val animations = AnimatorSet()
    val currentContentMoveUp = ObjectAnimator.ofFloat(currentContentText, "y", 0, -positionDeltaPx)
    currentContentMoveUp.setDuration(PaperOnboardingEngineDefaults.Companion.ANIM_CONTENT_TEXT_HIDE_TIME.toLong())
    currentContentMoveUp.addListener(object : AnimatorEndListener() {
      override fun onAnimationEnd(animation: Animator) {
        mContentTextContainer.removeView(currentContentText)
      }
    })
    val currentContentFadeOut = ObjectAnimator.ofFloat(currentContentText, "alpha", 1, 0)
    currentContentFadeOut.setDuration(PaperOnboardingEngineDefaults.Companion.ANIM_CONTENT_TEXT_HIDE_TIME.toLong())

    animations.playTogether(currentContentMoveUp, currentContentFadeOut)

    val newContentMoveUp = ObjectAnimator.ofFloat(newContentText, "y", positionDeltaPx, 0)
    newContentMoveUp.setDuration(PaperOnboardingEngineDefaults.Companion.ANIM_CONTENT_TEXT_SHOW_TIME.toLong())

    val newContentFadeIn = ObjectAnimator.ofFloat(newContentText, "alpha", 0, 1)
    newContentFadeIn.setDuration(PaperOnboardingEngineDefaults.Companion.ANIM_CONTENT_TEXT_SHOW_TIME.toLong())
  ...
  protected fun createContentIconShowAnimation(currentContentIcon: View, newContentIcon: View): AnimatorSet {
    val positionDeltaPx = dpToPixels(PaperOnboardingEngineDefaults.Companion.CONTENT_ICON_POS_DELTA_Y_DP)
    val animations = AnimatorSet()
    val currentContentMoveUp = ObjectAnimator.ofFloat(currentContentIcon, "y", 0, -positionDeltaPx)
    currentContentMoveUp.setDuration(PaperOnboardingEngineDefaults.Companion.ANIM_CONTENT_ICON_HIDE_TIME.toLong())
    ...
    val currentContentFadeOut = ObjectAnimator.ofFloat(currentContentIcon, "alpha", 1, 0)
    currentContentFadeOut.setDuration(PaperOnboardingEngineDefaults.Companion.ANIM_CONTENT_ICON_HIDE_TIME.toLong())

    animations.playTogether(currentContentMoveUp, currentContentFadeOut)

    val newContentMoveUp = ObjectAnimator.ofFloat(newContentIcon, "y", positionDeltaPx, 0)
    newContentMoveUp.setDuration(PaperOnboardingEngineDefaults.Companion.ANIM_CONTENT_ICON_SHOW_TIME.toLong())

    val newContentFadeIn = ObjectAnimator.ofFloat(newContentIcon, "alpha", 0, 1)
    newContentFadeIn.setDuration(PaperOnboardingEngineDefaults.Companion.ANIM_CONTENT_ICON_SHOW_TIME.toLong())
  ...
  protected fun createContentCenteringVerticalAnimation(newContentText: View, newContentIcon: View): Animator {
    ...
    centerContentAnimation.setDuration(PaperOnboardingEngineDefaults.Companion.ANIM_CONTENT_CENTERING_TIME.toLong())
  ...
  protected fun createPagerIconAnimation(oldIndex: Int, newIndex: Int): AnimatorSet {
    val animations = AnimatorSet()
    animations.duration = PaperOnboardingEngineDefaults.Companion.ANIM_PAGER_ICON_TIME.toLong()
    ...
    val oldActiveIconFadeOut = ObjectAnimator.ofFloat(oldActiveIcon, "alpha", 1, 0)
    ...
    val oldActiveShapeFadeIn = ObjectAnimator.ofFloat(oldActiveShape, "alpha", 0, PaperOnboardingEngineDefaults.Companion.PAGER_ICON_SHAPE_ALPHA)
    // add animations
    ...
    val newActiveIconFadeIn = ObjectAnimator.ofFloat(newActiveIcon, "alpha", 0, 1)

    // fade out new element shape
    val newActiveShape = newActiveItem.getChildAt(0) as ImageView
    val newActiveShapeFadeOut = ObjectAnimator.ofFloat(newActiveShape, "alpha", PaperOnboardingEngineDefaults.Companion.PAGER_ICON_SHAPE_ALPHA, 0)
  ...
  protected fun createPagerIconElement(iconDrawableRes: Int, isActive: Boolean): ViewGroup {
    ...
    if (isActive) {
      ...
      elementShape.alpha = PaperOnboardingEngineDefaults.Companion.PAGER_ICON_SHAPE_ALPHA
